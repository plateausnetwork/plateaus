...
import (
	...
	distrtypes "github.com/rhizomplatform/plateaus/x/distribution/types"
)
...
type AppModule struct {
	...
	validationKeeper distrtypes.ValidationKeeper
}

// NewAppModule creates a new AppModule object
func NewAppModule(
	cdc codec.Codec, keeper keeper.Keeper, accountKeeper types.AccountKeeper,
	bankKeeper types.BankKeeper, stakingKeeper types.StakingKeeper, validationKeeper distrtypes.ValidationKeeper,
) AppModule {
	return AppModule{
...
func (am AppModule) Route() sdk.Route {
	return sdk.NewRoute(types.RouterKey, distribution.NewHandler(am.keeper))
}
