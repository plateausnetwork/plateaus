...
import (
	...
	_ "github.com/rhizomplatform/plateaus/client/docs/statik"

	"github.com/rhizomplatform/plateaus/app/ante"
	v2 "github.com/rhizomplatform/plateaus/app/upgrades/v2"
	v4 "github.com/rhizomplatform/plateaus/app/upgrades/v4"
	v5 "github.com/rhizomplatform/plateaus/app/upgrades/v5"
	v6 "github.com/rhizomplatform/plateaus/app/upgrades/v6"
	...
	erc20client "github.com/rhizomplatform/plateaus/x/erc20/client"
	erc20keeper "github.com/rhizomplatform/plateaus/x/erc20/keeper"
	erc20types "github.com/rhizomplatform/plateaus/x/erc20/types"
	"github.com/rhizomplatform/plateaus/x/incentives"
	incentivesclient "github.com/rhizomplatform/plateaus/x/incentives/client"
	incentiveskeeper "github.com/rhizomplatform/plateaus/x/incentives/keeper"
	incentivestypes "github.com/rhizomplatform/plateaus/x/incentives/types"
	"github.com/rhizomplatform/plateaus/x/inflation"
	inflationkeeper "github.com/rhizomplatform/plateaus/x/inflation/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".plateausd")
...
var (
	_ servertypes.Application = (*Plateaus)(nil)
	_ simapp.App              = (*Plateaus)(nil)
	_ ibctesting.TestingApp   = (*Plateaus)(nil)
)

// Plateaus implements an extended ABCI application. It is an application
...
// NewPlateaus returns a reference to a new initialized Ethermint application.
func NewPlateaus(
	logger log.Logger,
	db dbm.DB,
	...
	app.ValidationKeeper = validationkeeper.NewKeeper(appCodec, keys[validationtypes.StoreKey],
		app.GetSubspace(validationtypes.ModuleName), app.AccountKeeper, mem.NewStore(), app.ModuleAccountAddrs(), cast.ToStringMap(appOpts.Get(validationtypes.ModuleName)),
	)
...
func (app *Plateaus) Name() string { return app.BaseApp.Name() }
...
func (app *Plateaus) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *Plateaus) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// We are intentionally decomposing the DeliverTx method so as to calculate the transactions per second.
func (app *Plateaus) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Plateaus) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Plateaus) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Plateaus) ModuleAccountAddrs() map[string]bool {
...
func (app *Plateaus) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Plateaus's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Plateaus) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Plateaus's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Plateaus) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Plateaus's InterfaceRegistry
func (app *Plateaus) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Plateaus) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Plateaus) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *Plateaus) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Plateaus) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *Plateaus) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *Plateaus) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Plateaus) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

func (app *Plateaus) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Plateaus) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Plateaus) GetStakingKeeper() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Plateaus) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Plateaus) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Plateaus) GetTxConfig() client.TxConfig {
...
func (app *Plateaus) setupUpgradeHandlers() {
	// v2 upgrade handler
