...
func (suite *IBCTestingSuite) TestOnAcknowledgementPacketIBC() {
	...
	for _, tc := range testCases {
		suite.Run(fmt.Sprintf("Case %s", tc.name), func() {
			...
			coin := suite.chainA.App.(*app.Plateaus).BankKeeper.GetBalance(suite.chainA.GetContext(), senderAddr, "aevmos")
...
func (suite *IBCTestingSuite) TestOnRecvPacketIBC() {
	...
	for _, tc := range testCases {
		suite.Run(fmt.Sprintf("Case %s", tc.name), func() {
			...
			coin := suite.chainB.App.(*app.Plateaus).BankKeeper.GetBalance(suite.chainB.GetContext(), receiverAddr, "aevmos")
