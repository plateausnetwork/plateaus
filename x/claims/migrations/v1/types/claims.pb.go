...
func init() {
	proto.RegisterEnum("plateaus.claims.migration.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "plateaus.claims.migration.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "plateaus.claims.migration.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "plateaus.claims.migration.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("plateaus/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
